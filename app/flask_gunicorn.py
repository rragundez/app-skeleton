...
@click.option('--log-level', default='info', help='The granularity of Error log outputs. [info]')
@flask.cli.pass_script_info
def run_app(info, host, port, reload, debugger, workers, worker_class, threads, log_level):
